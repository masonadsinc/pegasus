      ...
      cards: [
        {
          ...
          title: 'General',
          desc: 'Agency name, timezone, branding, and AI configuration',
          detail: org?.gemini_api_key ? `${org?.timezone?.replace('America/', '').replace('_', ' ') || 'Pacific'} — AI key configured` : org?.timezone?.replace('America/', '').replace('_', ' ') || 'Pacific',
